# Using SPELL and Reproducing the Benchmark Results

This file contains information in how to install SPELL and reproduce the results
of the experiments using SML-Bench and DL-Learner.
...
available separately at 
 https://github.com/spell-system/benchmarks, but can also be generated using the benchmark generators.

## Setting up SPELL

This should work with python 3.10.9.

Create a python virtual enviroment (so that we don't install dependencies in the global environment):
```
...
This should work with openjdk 19 and maven 3.8.7
